...
if not vim.loop.fs_stat(lazypath) then
  vim.fn.system {
    ...
    '--branch=stable', -- último release estável
    lazypath,
  }
end
...
require('lazy').setup({
  ...
  --  A configuração está pronta abaixo. Procure por lspconfig para encontra-la.
    ...
    dependencies = {
      -- Automaticamente instala LSPs do stdpath para o neovim
      'williamboman/mason.nvim',
      'williamboman/mason-lspconfig.nvim',

      -- Updates de status úteis para o LSP
...

  {
    ...
    'hrsh7th/nvim-cmp',
    dependencies = {
      -- Snippet Engine e sua associação com o nvim-cmp
      'L3MON4D3/LuaSnip',
      ...
      -- Adiciona um número de snippets amigáveis ao usuário
